...
1. Download and extract the repository files: Use the command "git clone https://github.com/sol-memelabs/sol-sniper-bot" or click the green "Code" button and select "Download ZIP".
